  ...
  return (
    <div className="min-h-screen pb-28 md:pb-0" style={{ backgroundColor: 'var(--color-background)' }}>
      ...
      <a
        ...
        className="fixed bottom-32 right-5 md:bottom-8 md:right-8 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-xl hover:scale-110 transition-transform"
      ...
      >
        <svg viewBox="0 0 24 24" fill="white" className="w-7 h-7">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.555 4.118 1.524 5.847L.057 23.286a.75.75 0 00.916.919l5.535-1.458A11.946 11.946 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.882a9.867 9.867 0 01-5.034-1.378l-.36-.214-3.738.984.998-3.633-.235-.374A9.856 9.856 0 012.118 12C2.118 6.52 6.52 2.118 12 2.118S21.882 6.52 21.882 12 17.48 21.882 12 21.882z"/>
        </svg>
      </a>
    </div>
  );
