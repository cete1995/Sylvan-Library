      ...
      <div className="aspect-[5/7] relative overflow-hidden" style={{ backgroundColor: 'var(--color-background)' }}>
        {isDfc && (
          <button
            ...
            className="absolute bottom-0 left-0 right-0 z-10 py-1.5 flex items-center justify-center gap-1 text-xs font-bold tracking-wide"
            style={{ backgroundColor: 'rgba(0,0,0,0.72)', color: 'white', backdropFilter: 'blur(3px)' }}
          ...
          >
            ...
            {showFront ? 'BACK FACE' : 'FRONT FACE'}
          </button>
        )}
        {displayUrl ? (
          <img
