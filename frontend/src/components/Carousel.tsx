...
const Carousel: React.FC<CarouselProps> = ({ images, autoPlay = true, interval = 5000 }) => {
  ...
  if (images.length === 0) {
    return (
      <div className="relative w-full bg-gray-200 flex items-center justify-center" style={{ aspectRatio: '1126/450' }}>
        <p className="text-gray-500 text-xl">No carousel images available</p>
      </div>
    );
  }
